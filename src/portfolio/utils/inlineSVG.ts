...
<svg xmlns="http://www.w3.org/2000/svg" style="display: none;">
   <symbol id="_inline_arrowup" viewBox="0 0 60 60" fill="none" stroke="currentColor">
   ...
   <symbol id="_inline_arrowdown" viewBox="0 0 60 60" stroke="currentColor" fill="none">
   ...
   <symbol id="_inline_music_vis" viewBox="0 0 130 60" fill="none" stroke="currentColor" stroke-linecap="round" stroke-width="7">
